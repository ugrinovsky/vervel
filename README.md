...
Фитнес-платформа для **атлетов** и **тренеров**: учёт тренировок, 2D-аватар и зоны нагрузки/восстановления, календарь и аналитика, периодизация (ATL/CTL/TSB), прогрессия и силовой дневник, чаты и расписание, **видеозвонки** (LiveKit), **AI** (Yandex: фото/текст тренировки, парсинг заметок, чат-советник), кошелёк и оплата **ЮKassa**, серии и достижения, лидерборды по группам, web push, PWA.
