...
- "макс", "MAX", "до отказа" вместо числа повторов в строке упражнения (например "Подтягивания - макс"): один подход; reps укажи как 12 (разумная заглушка для UI) или 1 если явно один подход на максимум — вес не выдумывай.
- КРОССФИТ-ФОРМАТЫ: строки вида "ЗКМБР N мин", "АМРАП N мин", "AMRAP N min", "For Time", "EMOM N мин", "Табата", "На время N мин" и подобные — это описание формата тренировки, а НЕ упражнения. Не добавляй их в exercises. Упражнения — только конкретные движения под этими заголовками (трастеры, канат, скакалка и т.д.)`
