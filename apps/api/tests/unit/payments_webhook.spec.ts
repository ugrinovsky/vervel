...
test.group('isYookassaIp: невалидные IP', () => {
  ...
  test('185.71.76.999.1 — некорректный IP с совпадающим префиксом (попытка обхода)', ({ assert }) => {
  ...
  test('77.75.156.12 — не входит в точные разрешённые адреса и не совпадает с префиксами', ({ assert }) => {
