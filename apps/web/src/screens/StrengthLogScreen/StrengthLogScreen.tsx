              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] text-(--color_text_muted) leading-snug px-0.5">
                  ...
                  {unlinkedTotalCount > aiSuggestCap
                    ...
                    : ''}{' '}
                  Перед отправкой эталоны с одинаковым названием (с учётом регистра и ё/е) автоматически
                  сливаются в один — списание только после успешной подготовки.
                </p>
              </div>
            )}
          </div>
        ...
        >
          <div className="space-y-3 pb-4 text-sm">
            <p className="text-xs text-(--color_text_muted) leading-relaxed">
              ИИ сопоставляет названия из вашей истории с уже созданными эталонами. Перед запросом
              дубликаты эталонов с одним и тем же названием объединяются на сервере (остаётся эталон с
              меньшим номером, связи упражнений сохраняются). Проверьте каждую строку и снимите галочки с
              сомнительных — модель может ошибаться. После применения можно откатить весь пакет одной
