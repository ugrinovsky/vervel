      ...
      <Wrap>
        <div className="lnd-two-col">
          <motion.div {...fade()}>
            ...
            <Sub>
              Открывается в браузере на телефоне и компьютере; можно закрепить на главном экране, как
              обычное приложение. Один аккаунт — роли атлет, тренер или обе с переключением кабинета.
            </Sub>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 9 }}>
              <Check text="Уведомления из браузера — не пропустить сообщение от тренера или атлета" />
          ...
          >
            ...
            <LandingPhoneMock
              ...
              w={200}
              icon="🔔"
              caption="Уведомления из браузера"
              label="Уведомления"
              dim
              shrink={0.92}
              mt={36}
