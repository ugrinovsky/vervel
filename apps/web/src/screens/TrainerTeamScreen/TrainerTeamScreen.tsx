      ...
      <div className="px-4 pt-4">
        ...
        >
          ...
          >
            ...
            />
            <ScreenHint>
              <span className="text-white font-medium">Атлеты</span> — список людей, которых вы
              ведёте; <span className="text-white font-medium">Группы</span> — несколько человек
              вместе и отдельный чат. Приглашения и переписки завязаны на этих списках.
              {prefersIndividual ? (
                <span className="block mt-2 text-(--color_text_muted)">
                  В настройках указан формат «персональная работа» — открывается вкладка «Атлеты»,
                  но группы здесь же, если они вам нужны.
                </span>
              ) : null}
            </ScreenHint>
          </motion.div>
