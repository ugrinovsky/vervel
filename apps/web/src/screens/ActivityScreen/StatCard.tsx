...
export default function StatCard({
  ...
  return (
    ...
    >
      <div
        className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${colorClass[color]} ${wrapClass[color]}`}
      >
        {icon}
      </div>
      <div>
        <div
          className={`text-xl font-bold leading-tight ${colorClass[color]} group-hover:scale-105 transition-transform`}
        >
          {displayValue}
        </div>
