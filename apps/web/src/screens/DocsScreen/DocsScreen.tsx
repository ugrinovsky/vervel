      ...
      <>
        ...
        <Section title="2. Какие данные мы собираем">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              <strong>Данные AI-запросов:</strong> текст сообщений в AI-чате (используется для
              обработки запросов).
            </li>
          </ul>
        </Section>
        ...
        <Section title="4. Передача данных третьим лицам">
          ...
          <ul className="list-disc list-inside space-y-1 mt-2">
            ...
            <li>
              <strong>Yandex Cloud (Алиса)</strong> — AI-платформа для обработки запросов в AI-чате.
            </li>
      ...
      <>
        ...
        <Section title="2. Описание услуг">
          ...
          <ul className="list-disc list-inside space-y-1 mt-2">
            ...
            <li>
              AI-ассистент: помощь в составлении программ тренировок, питания и восстановления.
            </li>
            <li>
              AI-распознавание тренировок: преобразование описания в структурированную запись.
            </li>
        ...
        <Section title="3. Стоимость и порядок оплаты">
          <p>
            Базовый доступ к Сервису бесплатен. Платные функции (AI-чат, AI-распознавание,
            AI-генерация тренировок) оплачиваются с внутреннего баланса кошелька.
          </p>
          <p className="mt-2">
        ...
        <Section title="6. Ограничение ответственности">
          <p>
            Сервис предоставляется «как есть». Рекомендации AI-ассистента носят информационный
