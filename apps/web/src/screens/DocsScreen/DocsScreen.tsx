...
const DOCS: Record<string, { title: string; content: React.ReactNode }> = {
  '/docs/privacy': {
    ...
    content: (
      <>
        <p className="text-xs text-(--color_text_muted) mb-6">
          Последнее обновление: 1 марта 2026 г.
        </p>

        <Section title="1. Общие положения">
          <p>
            Настоящая Политика конфиденциальности (далее — «Политика») описывает, как Vervel (далее
            — «мы», «Сервис») собирает, использует и защищает персональные данные пользователей
            (далее — «Пользователь») при использовании мобильного и веб-приложения Vervel.
          </p>
          <p className="mt-2">
        ...
        <Section title="2. Какие данные мы собираем">
          <ul className="list-disc list-inside space-y-1">
            <li>
              <strong>Регистрационные данные:</strong> имя, адрес электронной почты, пароль (в
              хэшированном виде).
            </li>
            <li>
              <strong>Данные профиля:</strong> пол, фотография, специализации и образование (для
              тренеров).
            </li>
            <li>
              <strong>Данные тренировок:</strong> упражнения, подходы, повторения, веса, дата и
              время тренировок.
            </li>
            <li>
              <strong>Платёжные данные:</strong> сумма пополнения баланса, история транзакций.
              Данные банковских карт мы не храним — они обрабатываются платёжным сервисом ЮКасса.
            </li>
            <li>
              <strong>Технические данные:</strong> IP-адрес, тип браузера и устройства, cookies.
            </li>
            <li>
              <strong>Данные ИИ-запросов:</strong> текст сообщений в ИИ-чате (используется для
              обработки запросов).
            </li>
          </ul>
        </Section>
        ...
        <Section title="3. Как мы используем данные">
          <ul className="list-disc list-inside space-y-1">
            <li>Предоставление функций Сервиса: учёт тренировок, аналитика, чаты, ИИ-помощник.</li>
        ...
        <Section title="4. Передача данных третьим лицам">
          ...
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>
              <strong>ЮКасса</strong> — платёжный сервис для обработки пополнений баланса.
            </li>
            <li>
              <strong>Yandex Cloud (Алиса)</strong> — ИИ-платформа для обработки запросов в ИИ-чате.
            </li>
        ...
        <Section title="5. Хранение и защита данных">
          <p>
            Данные хранятся на серверах, расположенных в Российской Федерации. Мы применяем
            технические и организационные меры для защиты данных от несанкционированного доступа:
            шифрование HTTPS, хэширование паролей, разграничение прав доступа.
          </p>
        </Section>
        ...
        <Section title="7. Cookies">
          <p>
            Мы используем технические cookies, необходимые для авторизации и работы Сервиса.
            Аналитические и маркетинговые cookies не используются.
          </p>
        </Section>
      ...
      <>
        ...
        <Section title="2. Описание услуг">
          ...
          <ul className="list-disc list-inside space-y-1 mt-2">
            ...
            <li>
              ИИ-ассистент: помощь в составлении программ тренировок, питания и восстановления.
            </li>
            <li>
              ИИ-распознавание тренировок: преобразование описания в структурированную запись.
            </li>
        ...
        <Section title="3. Стоимость и порядок оплаты">
          <p>
            Базовый доступ к Сервису бесплатен. Платные функции (ИИ-чат, ИИ-распознавание,
            ИИ-генерация тренировок) оплачиваются с внутреннего баланса кошелька.
          </p>
          <p className="mt-2">
            <strong>Тарифы:</strong>
          </p>
          <ul className="list-disc list-inside space-y-1 mt-1">
            <li>ИИ-чат — от 0.5₽ за сообщение (в зависимости от длины).</li>
            <li>Распознавание тренировки по фото — 9₽.</li>
            <li>Генерация тренировки ИИ (для тренеров) — 10₽.</li>
          </ul>
          <p className="mt-2">
            Пополнение баланса осуществляется через платёжный сервис ЮКасса. Минимальная сумма
            пополнения — 100₽.
          </p>
        </Section>
        ...
        <Section title="5. Права и обязанности сторон">
          ...
          <ul className="list-disc list-inside space-y-1 mt-1">
            <li>
              Обеспечивать доступность Сервиса 24/7 (за исключением плановых и аварийных технических
              работ).
            </li>
        ...
        <Section title="6. Ограничение ответственности">
          <p>
            Сервис предоставляется «как есть». Рекомендации ИИ-ассистента носят информационный
            характер и не заменяют консультацию специалиста по физической подготовке или врача.
            Исполнитель не несёт ответственности за травмы и ущерб здоровью, связанные с выполнением
    ...
    content: (
      <>
        ...
        <Section title="Платёжная информация">
          <p>
            Приём платежей осуществляется через сервис <strong>ЮКасса</strong> (ООО НКО «ЮМани»,
            лицензия ЦБ РФ).
          </p>
          <p className="mt-2 text-(--color_text_muted) text-sm">
            Данные вашей банковской карты не хранятся на наших серверах — они обрабатываются
            напрямую платёжной системой ЮКасса.
          </p>
        </Section>
        ...
        <Section title="Применимое право">
          <p className="text-(--color_text_muted) text-sm">
            Деятельность осуществляется в соответствии с законодательством Российской Федерации, в
            том числе Федеральным законом № 152-ФЗ «О персональных данных» и Законом РФ «О защите
            прав потребителей».
          </p>
        </Section>
        ...
        <Section title="По всем вопросам">
          ...
          <p className="text-(--color_text_muted) text-sm mt-1">
            Мы отвечаем в течение 1–3 рабочих дней.
          </p>
        </Section>
      </>
    ),
