    ...
    <Screen className="progression-hub-screen">
      <div className="p-4 w-full max-w-lg mx-auto space-y-4">
        ...
        <ScreenHeader
          ...
          description="Журнал с весом: таблица подходов, график и сводка за 30 дней. Эталон объединяет разные названия одного упражнения (каталог, своё имя, ИИ) в одну карточку."
        />
