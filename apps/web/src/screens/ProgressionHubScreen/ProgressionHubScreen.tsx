    ...
    <Screen className="progression-hub-screen">
      <div className="p-4 w-full max-w-lg mx-auto space-y-4">
        ...
        <ScreenHeader
          ...
          description="Журнал с весом: таблица подходов, график и сводка за 30 дней. Карточки разделены по типу тренировки (силовая, кроссфит, кардио). Эталон объединяет разные названия одного движения внутри типа."
        />
